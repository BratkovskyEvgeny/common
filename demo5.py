...
def main(
    ...
    st.sidebar.title("Поздравление от Братковского Евгения")
    ...
    st.markdown("<h1 style='text-align: center; '>Поздравляю с наступающим международным женским днём !</h1>", unsafe_allow_html = True)
    ...
    st.image('8mmm.gif')
    st.write("Кроме цветов, атрибут праздничного настроения, конечно же, шарики. По кнопке, расположенной ниже, сможете запускать их в любое время !")
